...
extension UITableView {
    ...
    func initPullToRefresh(withPullTitle pullTitle: String = "", releaseTitle: String = "", loadingTitle: String = "", color: UIColor = Constant.Color.DarkBlue, completion: @escaping (()->())) {
    ...
    func initLoadMore(withColor color: UIColor = Constant.Color.DarkBlue, completion: @escaping (()->())) {
